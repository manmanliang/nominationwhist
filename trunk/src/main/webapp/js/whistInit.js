...
function removePlayer(playerId) {
	...
	// Remove the available player and add it to the available players if it's a comp
	$("#playerOrderList #" + playerId).hide();
    if ($("#playerOrderList #" + playerId).hasClass("computerPlayer")) {
